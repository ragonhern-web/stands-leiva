...
export const standText = ({
  es: {
    ...
    juguetes: ["Expositor Juguetes de Madera", "Juguetes de madera didácticos de venta constante durante todo el año."],
    toys: ["Expositor Toys", "Novedades y juguetes de importación exclusivos."],
    jug3: ["Juguetes", "Stand de juguetes de precio económico, perfectos para regalo e impulso de compra."],
  ...
  en: {
    ...
    juguetes: ["Wooden Toy Display", "Didactic wooden toys with constant year-round sales."],
    toys: ["Toys Display", "New releases and exclusive imported toys."],
    jug3: ["Toys", "Toy display at an affordable unit price. Children's toy items, ideal for gifting and impulse buying."],
  ...
  fr: {
    ...
    juguetes: ["Présentoir Jouets en Bois", "Jouets en bois didactiques à vente constante toute l'année."],
    toys: ["Présentoir Toys", "Nouveautés et jouets d'importation exclusifs."],
    jug3: ["Jouets", "Présentoir de jouets à prix unitaire économique. Articles pour enfants, idéaux pour offrir et l'achat impulsif."],
  ...
  it: {
    ...
    juguetes: ["Espositore Giocattoli Legno", "Giocattoli in legno didattici a vendita costante tutto l'anno."],
    toys: ["Espositore Toys", "Novità e giocattoli d'importazione esclusivi."],
    jug3: ["Giocattoli", "Espositore di giocattoli a prezzo unitario economico. Giochi per bambini, perfetti come regalo e acquisto d'impulso."],
  ...
  pt: {
    ...
    juguetes: ["Expositor Brinquedos de Madeira", "Brinquedos didáticos de madeira de venda constante durante todo o ano."],
    toys: ["Expositor Toys", "Novidades e brinquedos de importação exclusivos."],
    jug3: ["Brinquedos", "Expositor de brinquedos a preço unitário económico. Artigos para crianças, ideais para oferecer e compra por impulso."],
...
(standText as unknown as Record<Language, Record<string, [string, string]>>).de = {
  ...
  jug3: ["Spielzeug", "Spielzeug-Expositeur zu günstigem Stückpreis. Kinderspielzeug, ideal als Geschenk und Impulskauf."],
...
(standText as unknown as Record<Language, Record<string, [string, string]>>).nl = {
  ...
  jug3: ["Speelgoed", "Speelgoed-expositeur tegen een voordelige stukprijs. Kinderspeelgoed, ideaal als cadeau en impulsaankoop."],
...
(standText as unknown as Record<Language, Record<string, [string, string]>>).pl = {
  ...
  jug3: ["Zabawki", "Ekspozytor z zabawkami w przystępnej cenie za sztukę. Zabawki dla dzieci, idealne jako prezent i zakup impulsowy."],
...
(standText as unknown as Record<Language, Record<string, [string, string]>>).ro = {
  ...
  juguetes: ["Expozitor Jucării din Lemn", "Jucării din lemn didactice cu vânzare constantă tot anul."],
  toys: ["Expozitor Toys", "Noutăți și jucării de import exclusive."],
  jug3: ["Jucării", "Expozitor de jucării la preț unitar accesibil. Jucării pentru copii, ideale ca cadou și cumpărătură impulsivă."],
