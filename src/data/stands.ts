...
const standExtras: Record<string, StandExtra> = {
  ...
  feb: {
    ...
    data: {
      32348: { units: "28", color: "Negro y rojo",                    alto: 20, largo: 3,   ancho: 8,  name: "Trampa adhesiva cucarachas (2u)",  desc: "Trampa adhesiva para cucarachas. Pack de 2 unidades." },
      32349: { units: "28", color: "Negro y rojo",                    alto: 20, largo: 3,   ancho: 8,  name: "Trampa adhesiva hormigas (2u)",    desc: "Trampa adhesiva para hormigas. Pack de 2 unidades." },
      ...
      32358: { units: "44", color: "Marrón",                          alto: 36, largo: 1,   ancho: 8,  name: "Incienso de citronela (20u)",       desc: "Incienso de citronela. Pack de 20 unidades." },
  ...
  may: {
    ...
    data: {
      ...
      60374: { units: "8",  color: "Varios colores surtidos", alto: 25, largo: 4,  ancho: 26, name: "Pack 2 pistolas agua grandes",       desc: "Pack de 2 pistolas de agua grandes en caja abierta, con diseño tipo lanzador para juego exterior." },
