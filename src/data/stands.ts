...
const standExtras: Record<string, StandExtra> = {
  ...
  jug3: {
    ...
    info: { standRef: "99915", numRefs: 33, sides: 2, pricePerUnit: "1,78 €", tipo: "Medio Palé", standAlto: 150, standLargo: 80, standAncho: 60 },
    ...
    data: {
      ...
      60469: { alto: 24, largo: 5,  ancho: 15, name: "Juego Guess Animals",                desc: "Juego Guess Animals con tablero abatible y tarjetas de animales." },
      60470: { alto: 24, largo: 5,  ancho: 15, name: "Juego Stackers bloques apilables",  desc: "Juego Stackers de bloques apilables de equilibrio." },
      60471: { alto: 13, largo: 7,  ancho: 10, name: "Peonza giratoria Cool Top",         desc: "Peonza giratoria con lanzador y piezas apilables tipo Cool Top." },
      60472: { alto: 21, largo: 4,  ancho: 28, name: "Set muñeca accesorios peluquería",  desc: "Set de muñeca con accesorios de peluquería, vestido, espejo, peine y secador." },
      60473: { alto: 16, largo: 3,  ancho: 30, name: "Kit DIY abalorios pulseras",        desc: "Kit DIY de abalorios para crear pulseras y bisutería infantil." },
      60474: { alto: 33, largo: 2,  ancho: 17, name: "Set belleza infantil con corona",   desc: "Set de belleza infantil con corona, collar, pendientes y accesorios." },
      60475: { alto: 15, largo: 4,  ancho: 24, name: "Xilófono infantil de colores",     desc: "Xilófono infantil con teclas de colores y baqueta." },
      60476: { alto: 16, largo: 7,  ancho: 22, name: "Dinosaurio desmontable DIY",       desc: "Dinosaurio desmontable DIY con piezas y tornillos visibles." },
      60477: { alto: 23, largo: 8, ancho: 8, name: "Set bloques puzzle geométricos", desc: "Set de bloques puzzle encajables con formas geométricas." },
      60478: { name: "Reloj educativo de madera",        desc: "Reloj educativo de madera con números encajables de colores y cordón." },
      60479: { alto: 32, largo: 4,  ancho: 14, name: "Muñeca Fashion Girl vestido rojo", desc: "Muñeca Fashion Girl con vestido rojo y accesorios de belleza." },
      60480: { alto: 32, largo: 4, ancho: 14, name: "Muñeca Fashion Girl vestido blanco", desc: "Muñeca Fashion Girl con vestido blanco y morado." },
      60481: { alto: 32, largo: 4,  ancho: 14, name: "Muñeca Fashion Girl vestido rosa",  desc: "Muñeca Fashion Girl con vestido rosa y lazo rojo." },
      60482: { alto: 32, largo: 4,  ancho: 14, name: "Muñeca Fashion Girl encaje rosa",   desc: "Muñeca Fashion Girl con vestido rosa claro y falda de encaje." },
      60483: { alto: 40, largo: 3,  ancho: 15, name: "Set arco y flechas con diana",     desc: "Set de arco y flechas con diana para juego de puntería." },
      60484: { alto: 25, largo: 3,  ancho: 15, name: "Juego Bingo habilidad 2 jugadores",desc: "Juego Bingo de habilidad para 2 jugadores con tablero y fichas." },
      60485: { alto: 21, largo: 5,  ancho: 16, name: "Set militar figuras de combate",   desc: "Set militar con figuras, soldados, accesorios y elementos de combate." },
      60486: { alto: 15, largo: 4,  ancho: 22, name: "Pistola Shoot Gun balas blandas",  desc: "Pistola de juguete Shoot Gun con balas blandas y bolas." },
      60487: { alto: 25, largo: 3, ancho: 20, name: "Set mosaico plástico tablero",    desc: "Set de mosaico plástico con tablero perforado y piezas de colores." },
      60488: { alto: 18, largo: 5, ancho: 26, name: "Set Dinosaur World figuras", desc: "Set Dinosaur World con figuras de dinosaurios y vegetación decorativa." },
      60489: { alto: 21, largo: 4,  ancho: 28, name: "Set espacial Space Team",          desc: "Set espacial Space Team con nave, astronautas, cohete, torre y planetas." },
      60490: { alto: 23, largo: 5, ancho: 18, name: "Set Jurassic Play World", desc: "Set de dinosaurios Jurassic Play World con figuras, huevos y accesorios." },
      60491: { alto: 22, largo: 4,  ancho: 20, name: "Set Train Track Dinosaur World",   desc: "Set Train Track Dinosaur World con tren, vagones y vías." },
      60492: { alto: 19, largo: 5, ancho: 12, name: "Robot Warrior Mecha", desc: "Robot Warrior Mecha con accesorio de arma, varios modelos surtidos." },
      60493: { alto: 20, largo: 4,  ancho: 15, name: "Juego Rummikub Family Games",      desc: "Juego de mesa Rummikub Family Games con fichas numéricas y soportes." },
      60494: { alto: 20, largo: 4, ancho: 15, name: "Juego Ladders Balancing Game", desc: "Juego Ladders Balancing Game con escaleras de colores para equilibrio." },
      60495: { alto: 20, largo: 4, ancho: 15, name: "Juego Topple apilables",       desc: "Juego Topple con base azul y piezas apilables de colores." },
      60496: { alto: 11, largo: 4,  ancho: 20, name: "Set Horse Farm con caballo",       desc: "Set Horse Farm con caballo, accesorios de establo y herramientas." },
      60497: { alto: 18, largo: 4, ancho: 25, name: "Set Beautiful Fashion Set",   desc: "Set Beautiful Fashion Set con muñeca, vestidos, bolso, peine y accesorios." },
      60498: { alto: 21, largo: 4,  ancho: 25, name: "Set Fashion Girl Collection",      desc: "Set Fashion Girl Collection con accesorios de belleza, espejo, bolso, perfume y complementos." },
      60499: { alto: 21, largo: 4,  ancho: 25, name: "Set Fashion Dolls Pets",           desc: "Set Fashion Dolls Pets con muñeca, vestidos intercambiables, mascotas y accesorios." },
      60500: { alto: 14, largo: 3,  ancho: 40, name: "Set Combat Play Set soldados",     desc: "Set militar Combat Play Set con varias figuras de soldados." },
    },
  },
...
const seasonalDefs: StandDef[] = [
  ...
  { id: "feb", label: "FEB", color: "#2d87c8", gradient: "linear-gradient(135deg, #6dc3f5 0%, #2d87c8 48%, #0e4a7a 100%)", title: "Expositor Picnic",            desc: "Vajilla, vasos y accesorios desechables para picnic, celebraciones y hostelería.",                  productsBase: ["Platos", "Vasos", "Cubiertos", "Servilletas"] },
  { id: "mar", label: "MAR", color: "#5f9f4b", gradient: "linear-gradient(135deg, #9fd87a 0%, #5f9f4b 48%, #2a5a1a 100%)", title: "Expositor Repelentes",        desc: "Repelentes, trampas y productos anti-insectos para el inicio del calor.",                           productsBase: ["Pulseras repelentes", "Velas citronela", "Espirales", "Trampas"] },
  { id: "abr", label: "ABR", color: colorMap.darkGreen, gradient: "linear-gradient(135deg, #4dc862 0%, #087a18 48%, #03350a 100%)", title: "Expositor Churros Flotación", desc: "Churros de flotación de espuma de polietileno para piscina y playa.",                          productsBase: ["Churros flotación", "Colores surtidos"] },
  { id: "may", label: "MAY", color: "#77b35c", gradient: "linear-gradient(135deg, #b4e585 0%, #77b35c 48%, #3a6828 100%)", title: "Expositor Colección Natural", desc: "Juguetes de playa y exterior de la colección natural con materiales sostenibles.",                productsBase: ["Palas madera", "Sets playa", "Regaderas", "Juegos buceo"] },
  { id: "jun", label: "JUN", color: "#e5a2a2", gradient: "linear-gradient(135deg, #f5d0d0 0%, #e5a2a2 48%, #a84f4f 100%)", title: "Expositor Playa",             desc: "Todo para la playa y piscina: pistolas de agua, sets de arena y juegos acuáticos.",                productsBase: ["Pistolas agua", "Sets playa", "Juego buceo", "Carretillas"] },
  { id: "jul", label: "JUL", color: "#df8b8b", gradient: "linear-gradient(135deg, #f0bebe 0%, #df8b8b 48%, #9b4040 100%)", title: "Expositor Set de Playa",      desc: "Los productos estrella para playa, piscina y verano.",                                              productsBase: ["Cubos y palas", "Pistolas de agua", "Flotadores", "Gafas buceo"] },
  { id: "ago", label: "AGO", color: "#d66a6a", gradient: "linear-gradient(135deg, #ebb0b0 0%, #d66a6a 48%, #8a2e2e 100%)", title: "Expositor Papelería",         desc: "Vuelta al cole con material escolar, papelería y accesorios de escritorio.",                        productsBase: ["Bolígrafos", "Carpetas", "Estuches", "Tijeras"] },
  { id: "sep", label: "SEP", color: "#d9a14c", gradient: "linear-gradient(135deg, #f5d08a 0%, #d9a14c 48%, #8a5a10 100%)", title: "Expositor Halloween",         desc: "Disfraces, decoración y accesorios para campañas de impacto visual.",                               productsBase: ["Maquillaje", "Disfraces", "Calabazas", "Decoración"] },
  { id: "oct", label: "OCT", color: "#d89a54", gradient: "linear-gradient(135deg, #f5c98a 0%, #d89a54 48%, #8a540f 100%)", title: "Expositor Navidad",           desc: "Adornos, luces y decoración navideña para la campaña de temporada.",                                productsBase: ["Adornos árbol", "Guirnaldas", "Figuras", "Gorros"] },
  { id: "nov", label: "NOV", color: "#d8a35f", gradient: "linear-gradient(135deg, #f5d3a0 0%, #d8a35f 48%, #8a5a1a 100%)", title: "Expositor Desechables Navidad", desc: "Vajilla y accesorios desechables con motivos navideños.",                                          productsBase: ["Vasos", "Platos", "Servilletas", "Manteles"] },
  { id: "dic", label: "DIC", color: "#2b6ea7", gradient: "linear-gradient(135deg, #62b0f0 0%, #2b6ea7 48%, #0e3d6a 100%)", title: "Expositor Cotillón",          desc: "Sets de cotillón y artículos de fiesta para fin de año.",                                           productsBase: ["Bolsas cotillón", "Gorros", "Matasuegras", "Confeti"] },
];

const allYearDefs: StandDef[] = [
  { id: "balones",  label: "BALONES",  color: colorMap.orange, gradient: "linear-gradient(135deg, #ffd166 0%, #f5a623 48%, #a85a00 100%)", title: "Expositor Balones",     desc: "Surtido completo de balones deportivos para todas las edades.",                productsBase: ["Balón fútbol", "Balón basket", "Voleibol", "Minipelota"] },
  { id: "mascotas", label: "MASCOTAS", color: colorMap.green,  gradient: "linear-gradient(135deg, #2edf52 0%, #169b22 48%, #093d0d 100%)", title: "Expositor Mascotas",    desc: "Juguetes, accesorios y productos de cuidado para mascotas.",                  productsBase: ["Mordedores", "Correas", "Cepillos", "Platos"] },
...
const comingSoonDefs: StandDef[] = [
  { id: "jug5",        label: "JUG 5€",      color: colorMap.green,  gradient: "linear-gradient(135deg, #2edf52 0%, #169b22 48%, #093d0d 100%)", title: "Juguetes (5€)",    desc: "Stand de juguetes a precio unitario de 5€. Mayor calidad y presentación, ideales como regalo.",                              productsBase: [] },
