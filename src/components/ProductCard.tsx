        ...
        <div className="mt-3 grid grid-cols-2 gap-2 border-t border-slate-100 pt-3 text-[10px]">
          {product.units && (
            <div>
              ...
              <div className="mt-1 flex h-7 items-center justify-center rounded-lg font-black text-black shadow-sm" style={{ backgroundColor: brand.yellow }}>
                {product.units}
              </div>
            </div>
          )}
          {product.price && (
            <div>
              ...
              <div className="mt-1 flex h-7 items-center justify-center rounded-lg font-black text-white shadow-sm" style={{ backgroundColor: brand.green }}>
                {product.price}
              </div>
            </div>
          )}
