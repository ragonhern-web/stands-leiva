export default function Logo() {
  return (
    <div className="fixed left-5 top-5 z-30 flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-2 shadow-lg shadow-slate-200/70 md:left-6">
